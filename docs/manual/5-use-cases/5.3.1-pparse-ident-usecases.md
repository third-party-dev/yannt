---
title: Ident Use Cases
first-section-number: "5.3.1"
---
...
<div class="h3-style">Use Case: List Known Serialized Model Formats</div>
...
xmodel - XModel
```
<!-- INLINE_ACTION_END: {"md5": "227471b26593996072138ba4fbf70b69"} -->
...
<div class="h3-style">Use Case: Show information about serialized model format</div>
...
<!-- INLINE_ACTION: {
    "cmd": ["yannt", "pparse", "ident", "show", "pytorch"],
    "header": "\n```text\n", "footer": "```\n"
} -->
```text
Name: PyTorch
...
```
<!-- INLINE_ACTION_END: {"md5": "aa0a7b4133e8646cf6719a44fd1e0828"} -->
...
<div class="h3-style">Use Case: Detect model by extension</div>
